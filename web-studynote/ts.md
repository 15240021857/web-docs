...
- 当你接手别人的代码、调用别人的函数，或是新人来接手别人代码时，js 无法知道变量和函数输入、输出参数是什么类型，而 ts 直观明了的标出来了，让你清晰明了，ts 相当于说明书;
- 开发时，ts 配合编辑器会有类型提示，如 searchForm.type, 当输入 searchForm.时，ts 会提示 type,直接回车选中参数即可，即方便又安全。
